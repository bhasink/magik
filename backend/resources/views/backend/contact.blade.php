    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="filters-groups">
                ...
                <p>Min Date : <input class="date-picker-min"  type="text"></p>
                <p>Max Date : <input class="date-picker-max"  type="text"></p></div>
                            ...
                            @foreach($contacts as $contact)
                                <tr class="odd gradeX">
                                    ...
                                    <td>{{$contact->gift_name}}</td>
                                     <td>@if($contact->serial_no>0){{$contact->serial_no}}@elseif($contact->serial_no=='0') Special Case @endif</td>
